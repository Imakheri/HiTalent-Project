...
const { Users, Posts, Categories, Orders, Orden_detail, Payments, Reviews, Favorites   } = sequelize.models;
...
Posts.hasMany(Favorites,{foreignKey:"post_id"})
Favorites.belongsTo(Posts,{foreignKey:"post_id"})
